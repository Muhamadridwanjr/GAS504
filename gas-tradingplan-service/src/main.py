"""FastAPI entry point for gas-tradingplan-service."""
...
app = FastAPI(title="gas-tradingplan-service", description="CRUD for daily/weekly trading plans.", version="1.0.0", lifespan=lifespan, docs_url="/docs", redoc_url="/redoc")
